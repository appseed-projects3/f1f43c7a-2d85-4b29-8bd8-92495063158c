...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-07 05:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f1f43c7a-2d85-4b29-8bd8-92495063158c.git
$ cd f1f43c7a-2d85-4b29-8bd8-92495063158c
```
